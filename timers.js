...
// every 1000 milliseconds and each time that a random number is picked, add 1
// to a counter. If the number is greater than .75, stop the timer and console.log
